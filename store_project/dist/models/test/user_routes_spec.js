...
describe('users Routes Model', function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    newUser = (_a.sent());
                    console.log("this new user : ".concat(newUser.firstname));
                    return [4 /*yield*/, ut.authnticate(theUser.firstname, theUser.pass)];
                case 2:
                    authuser = _a.sent();
                    spyOn(ut, 'index').and.returnValue(Promise.resolve([
                        {
                            id: 1,
                            firstname: 'mohamed1',
                            lastname: 'elhussieny1',
                    ...
                    spyOn(ut, 'insert').and.returnValue(Promise.resolve([
                        {
                            d: 2,
                            firstname: 'mohamed2',
    ...
    describe('Test users Route', function () {
        it('Test api it shoud get all users', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/user').set('Authorization', 'Bearer ' + secrettoken)];
                    case 1:
                        res = _a.sent();
        ...
        it('Test api it shoud create user', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res, usertoken;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('Test api it shoud delete user', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
