    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, pro.insert(result)];
            case 1:
                newproduct = _a.sent();
                res.json(newproduct);
                return [3 /*break*/, 3];
...
var up = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productname, price, id, updated, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                price = req.body.price;
                id = req.params.id;
                return [4 /*yield*/, pro.update(id, productname, price)];
            case 1:
                updated = _a.sent();
                res.json(updated);
                return [3 /*break*/, 3];
...
var productRoutes = function (app) {
    app.post('/product', auth_middleware_1.default, insert);
